...
#PETSC_ARCH := clx-i64
#PETSC_DIR  := TACC_PETSC64_LIB = /home1/apps/intel19/impi19_0/petsc/3.15/$(PETSC_ARCH)
#PETSC_LIB  := $(PETSC_DIR)/lib
#PETSC_INC  := $(PETSC_DIR)/include
PETSC_DIR :=
# NOTE: TACC_PETSC_DIR includes trailing / 
...
ifeq ($(MFEM_USE_SUPERLU)$(MFEM_USE_STRUMPACK)$(MFEM_USE_MUMPS),NONONO)
   ...
   METIS_OPT = -I$(TACC_PETSC_INC)
   METIS_LIB = -L$(TACC_PETSC_LIB) -lparmetis -lmetis
   MFEM_USE_METIS_5 = YES
endif

# LAPACK library configuration
LAPACK_OPT =
LAPACK_LIB = $(if $(NOTMAC),-mkl,-framework Accelerate)
...
PETSC_VARS := $(TACC_PETSC_LIB)/petsc/conf/petscvariables
...
ifeq ($(PETSC_FOUND),YES)
   ...
   PETSC_LIB = $(XLINKER)-rpath,$(abspath $(TACC_PETSC_LIB))\
      -L$(abspath $(TACC_PETSC_LIB)) -lpetsc\
