...
//
// Compile with: make forward_seq
//
// Sample runs:  forward_seq -m ../../data/square-disc.mesh
//               forward_seq -m ../../data/star.mesh
//               forward_seq -m ../../data/star.mesh -pa
//               forward_seq -m ../../data/beam-tet.mesh
//               forward_seq -m ../../data/beam-hex.mesh
//               forward_seq -m ../../data/beam-hex.mesh -pa
//               forward_seq -m ../../data/escher.mesh
//               forward_seq -m ../../data/fichera.mesh
//
...
int main(int argc, char *argv[])
{
   ...
   //     GLVis: "glvis -m forward_seq.mesh -g sol_u.gf" or "glvis -m forward_seq.mesh -g
   //     sol_p.gf".
   {
      ofstream mesh_ofs("forward_seq.mesh");
   ...
   VisItDataCollection visit_dc("ForwardSeq", mesh);
   visit_dc.RegisterField("velocity", &u);
   visit_dc.RegisterField("pressure", &p);
   visit_dc.Save();

   // 15. Save data in the ParaView format
   ParaViewDataCollection paraview_dc("ForwardSeq", mesh);
