//                       MFEM Cascadia Verification Code
//                         (parallel forward solver)
//
// Compile with: make forward_par
//
// Sample runs:  mpirun -np 4 forward_par -m ../data/square-disc.mesh
//               mpirun -np 4 forward_par -m ../data/star.mesh
//               mpirun -np 4 forward_par -m ../data/star.mesh -r 2 -pa
//               mpirun -np 4 forward_par -m ../data/beam-tet.mesh
//               mpirun -np 4 forward_par -m ../data/beam-hex.mesh
//               mpirun -np 4 forward_par -m ../data/beam-hex.mesh -pa
//               mpirun -np 4 forward_par -m ../data/escher.mesh
//               mpirun -np 4 forward_par -m ../data/fichera.mesh
//
// Device sample runs:
//               mpirun -np 4 forward_par -m ../data/star.mesh -r 2 -pa -d cuda
//               mpirun -np 4 forward_par -m ../data/star.mesh -r 2 -pa -d raja-cuda
//               mpirun -np 4 forward_par -m ../data/star.mesh -r 2 -pa -d raja-omp
//               mpirun -np 4 forward_par -m ../data/beam-hex.mesh -pa -d cuda
//
...
int main(int argc, char *argv[])
{
   ...
   VisItDataCollection visit_dc("ForwardPar", pmesh);
   ...
   ParaViewDataCollection paraview_dc("ForwardPar", pmesh);
